...
[%header,format=csv]
|===
include::ships/life_supporting_modules.csv[]
|===

.Life support equipment
[%header,format=csv]
|===
include::ships/life_support_equipment.csv[]
|===
...
[%header,format=csv]
|===
include::ships/cargo_modules.csv[]
|===
...
[%header,format=csv]
|===
include::ships/atmosphere_movement_rate.csv[]
|===
